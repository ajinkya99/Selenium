...
public class ExcelReader {
	...
	public String[][] getExcelData(String excellocation, String sheetName) {
		try {
			...
			String dataSets[][] = null; //Will be used to create array of row and columns
			
			FileInputStream file = new FileInputStream(new File(excellocation));   //Created the object of the FILE and given the excellocation path
	...
	public static void main(String[] args) {
		String excellocation = "C:\\selenium scripts\\FrameworkHybrid2\\src\\main\\java\\com\\hybridframework\\data\\TestData.xlsx";
